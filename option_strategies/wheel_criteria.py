...
WHEEL_TICKERS: list[WheelTicker] = [
    ...
    WheelTicker(
        ...
        instrument="stock", approx_price=466, multiplier=100,
        notional_per_contract=46_600, avg_iv_rank=45,
        options_liquidity="high", market_cap_b=525,
        dividend_yield=0.2, quality_score=8,
        notes="Memory/AI chips. Cyclical but high IV = great premiums.",
    ),
    WheelTicker(
        ticker="MRVL", name="Marvell Technology", sector="Semiconductors",
        instrument="stock", approx_price=134, multiplier=100,
        notional_per_contract=13_400, avg_iv_rank=45,
        options_liquidity="high", market_cap_b=117,
        dividend_yield=0.2, quality_score=8,
        notes="AI networking/custom silicon. High IV growth semi.",
    ),
    WheelTicker(
        ticker="SOFI", name="SoFi Technologies", sector="Fintech",
        instrument="stock", approx_price=18, multiplier=100,
        notional_per_contract=1_800, avg_iv_rank=55,
        options_liquidity="high", market_cap_b=23,
        dividend_yield=0.0, quality_score=7,
        notes="Speculative fintech. Lowest capital on list. Very high IV.",
    ),
    WheelTicker(
        ticker="NU", name="Nu Holdings Ltd.", sector="Fintech",
        instrument="stock", approx_price=15, multiplier=100,
        notional_per_contract=1_500, avg_iv_rank=50,
        options_liquidity="high", market_cap_b=75,
        dividend_yield=0.0, quality_score=7,
        notes="Latin America digital bank. Ultra-low capital. Speculative growth.",
    ),
    WheelTicker(
        ticker="MELI", name="MercadoLibre Inc.", sector="E-Commerce",
        instrument="stock", approx_price=1841, multiplier=100,
        notional_per_contract=184_100, avg_iv_rank=40,
        options_liquidity="high", market_cap_b=93,
        dividend_yield=0.0, quality_score=8,
        notes="Latin America Amazon+PayPal. Very high capital. Quality growth.",
    ),
    WheelTicker(
